    ...
    <div class="popup">
        <div class="content">
            <div class="setmode">
                ...
                <br/>
                <br/>
                <div class="button is-rounded is-danger">Screen peek</div>
            </div>
...
const sendDataToScreen = (id, data) => {
    fetch(`https://screenapi.adrienmoreau.fr?id=${id}`, {
        method: 'POST',
        headers: {
...
button.addEventListener('click', () => {
    if (numberOfRealRandom <= 0 && alreadyForced == false) {
        ...
        sendDataToScreen(screenID, goal)
